...
toolbox.router.get(/([\/]?)restaurants([\/]?)/, toolbox.networkFirst, {"cache":{"name":"restaurants-cache","maxEntries":1}});
toolbox.router.get(/([\/]?)(restaurants\/)[1,9]/, toolbox.networkFirst, {"cache":{"name":"restaurant-cache","maxEntries":10}});
toolbox.router.get(/(.*)/, toolbox.fastest, {"origin":/\.googleapis\.com\//,"cache":{"name":"googleapis-cache","maxEntries":1}});
toolbox.router.get(/(.*)/, toolbox.fastest, {"origin":/\.gstatic\.com\//,"cache":{"name":"gstatic-cache","maxEntries":1}});
