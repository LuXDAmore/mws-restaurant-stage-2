...
toolbox.router.get(/\/fonts.gstatic.com/, toolbox.fastest, {"cache":{"maxEntries":5,"name":"fonts-static-cache"}});
toolbox.router.get(/\/fonts.googleapis.com/, toolbox.fastest, {"cache":{"maxEntries":5,"name":"fonts-api-cache"}});
toolbox.router.get(/\/maps.gstatic.com/, toolbox.fastest, {"cache":{"maxEntries":5,"name":"maps-static-cache"}});
