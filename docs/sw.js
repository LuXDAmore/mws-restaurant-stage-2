...
toolbox.router.get(/http:\/\/localhost:1337\/restaurants([\/]?)/, toolbox.networkFirst, {"cache":{"maxEntries":1,"name":"restaurants-cache"}});
toolbox.router.get(/http:\/\/localhost:1337\/restaurants\/[1,9]/, toolbox.networkFirst, {"cache":{"maxEntries":10,"name":"restaurant-cache"}});
toolbox.router.get(/\/fonts\.gstatic\.com\//, toolbox.cacheFirst, {"cache":{"maxEntries":3,"name":"fonts-static-cache"}});
toolbox.router.get(/\/maps\.gstatic\.com\//, toolbox.cacheFirst, {"cache":{"maxEntries":3,"name":"maps-static-cache"}});
toolbox.router.get(/\/fonts\.googleapis\.com\//, toolbox.fastest, {"cache":{"maxEntries":3,"name":"fonts-api-cache"}});
toolbox.router.get(/\/maps\.googleapis\.com\//, toolbox.fastest, {"cache":{"maxEntries":3,"name":"maps-api-cache"}});
