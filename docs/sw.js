...
toolbox.router.get(/([\/]?)(restaurants)([\/]?)/, toolbox.networkFirst, {"cache":{"maxEntries":10,"name":"restaurants-cache"}});
toolbox.router.get(/([\/]?)(restaurants\/[1,9])/, toolbox.networkFirst, {"cache":{"maxEntries":10,"name":"restaurant-cache"}});
toolbox.router.get(/\/fonts\.gstatic\.com\//, toolbox.cacheFirst, {"cache":{"maxEntries":5,"name":"fonts-static-cache"}});
toolbox.router.get(/\/maps\.gstatic\.com\//, toolbox.cacheFirst, {"cache":{"maxEntries":5,"name":"maps-static-cache"}});
